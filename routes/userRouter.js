...
import { placeDirectOrder, checkoutCOD, getMyOrders, getSavedAddress, trackOrder, getUserOrderDetail, cancelUserOrder, submitReturnOrder } from "../controllers/orderController.js";
...
router.post("/orders/return", isUserLoggedIn, upload.none(), submitReturnOrder);
